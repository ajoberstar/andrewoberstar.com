...
begin:/>/,relevance:0}]}]}}})());hljs.registerLanguage("handlebars",(()=>{"use strict";function e(e){
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[E]}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
relevance:0},n]}],relevance:0}]}}})());hljs.registerLanguage("lisp",(()=>{"use strict";return e=>{
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("elixir",(()=>{"use strict";return e=>{
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
contains:[e.SHEBANG(),a,i,l,g,d].concat(c)}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}],illegal:/;/}}})());hljs.registerLanguage("asciidoc",(()=>{"use strict";return e=>({name:"AsciiDoc",
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("smalltalk",(()=>{"use strict";return e=>{
...
end:"\\)",contains:[e.APOS_STRING_MODE,a,e.C_NUMBER_MODE,s]}]}}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
},contains:[u]},s,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
variants:[e.COMMENT("--","$"),e.COMMENT(/\{-/,/-\}/,{contains:["self"]})]},i={
